  ...
  getNews = () => {
    return fetch(
      ...
      .then((data) => {
        ...
        this.setState({
          headline: XMLDocument.getElementsByTagName("item")[0]
            .firstElementChild.innerHTML.replace("<![CDATA[", "")
            .replace("]]>", ""),
          story: XMLDocument.getElementsByTagName("item")[0].firstElementChild
            .nextElementSibling.nextElementSibling.innerHTML,
          text: XMLDocument.getElementsByTagName("item")[0]
            .firstElementChild.nextElementSibling.innerHTML.replace(
              "<![CDATA[",
              ""
            )
            .replace("]]>", ""),
